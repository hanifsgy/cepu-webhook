...
struct CepuWebhook: SimpleLambdaHandler {
    ...
    func handle(_ request: APIGatewayV2Request, context: LambdaContext) async throws -> APIGatewayV2Response {
        ...
        - Status: \(payload.ciBuildRun.attributes.completionStatus.rawValue)
        - Started: \(formatDate(payload.ciBuildRun.attributes.startedDate))
        - Finished: \(formatDate(payload.ciBuildRun.attributes.finishedDate))
